                ...
                <nav aria-label="breadcrumb" class="banner-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <?//= \yii\helpers\Html::a($product->category->title, ['category/view', 'id' => ['category/view', 'id' => $product->category->id]$product->category->id]) ?>
                        </li>
        ...
        <div class="row s_product_inner">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    <h3><?=$product->title?></h3>
                    <h2><?=round($product->price)?> руб.</h2>
                    <ul class="list">
                        <li>
                            <a class="active" href="<?= \yii\helpers\Url::to(['category/view', 'id' => $product->category->id]) ?>">
                                <span>Категория</span> : <?=$product->category->title?>
                            </a>
                        </li>
